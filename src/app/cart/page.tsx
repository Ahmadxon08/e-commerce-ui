          ...
          {activeStep === 1 ? (
            cartItems.map((item) => (
              ...
              >
                ...
                {/* Button of delete */}
                <button className="flex justify-center cursor-pointer items-center w-6 h-6 bg-red-100 hover:bg-red-200 transition-all duration-300 text-red-400 rounded-full">
